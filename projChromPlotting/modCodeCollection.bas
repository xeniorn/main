...
Function DNALongestORF(Sequence As String, Optional Circular As Boolean = True, _
                        Optional Skip As Long = 1) As String
'====================================================================================================
...
'****************************************************************************************************
Function StringCompare(a As String, b As String, Optional Limit As Long = 25, Optional mode As String = "Verbose") As String
...
'****************************************************************************************************
Function StringCharCountLong(InputString As String, ParamArray Substrings() As Variant) As Long
...
For i = 1 To N
    temp = (StringLength - Len(Replace(InputString, Substrings(i - 1), ""))) / Len(Substrings(i - 1))
    result = result + temp
Next i

StringCharCountLong = result
...
'****************************************************************************************************
Function OptimizePrimer(TargetSequence As String, Optional TargetTm As Double = 60, Optional MinLength As Long = 15) As String
...
Dim i As Long, StringLength As Long
